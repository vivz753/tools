...
# Make a symlink from [GIT] ~/dev/vivz753/tools/Windows/bash_profile/.bashprofile to [LOCAL] ~/.bash_profile
# EXAMPLE: `ln -s ~/dev/vivz753/tools/Windows/bash_profile/.bash_profile ~/.bash_profile`
...
if (($# == 2))
then
	ssh-keygen -t rsa -b 4096 -C "$1" -f ~/.ssh/"$2" -N ""
